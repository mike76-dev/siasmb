module github.com/mike76-dev/siasmb
...
require (
	...
	go.sia.tech/core v0.16.0 // indirect
	go.sia.tech/coreutils v0.17.0 // indirect
	go.sia.tech/mux v1.4.0 // indirect
	go.sia.tech/renterd/v2 v2.6.0-beta.1 // indirect
